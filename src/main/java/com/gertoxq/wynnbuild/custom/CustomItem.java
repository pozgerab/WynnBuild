...
import static com.gertoxq.wynnbuild.client.WynnBuildClient.types;
...
//            System.out.println("No custom model data, prob armor or custom item");
        ...
        String name = removeTilFormat(Utils.removeFormat(item.getName().getString()));
        ...
        lore.forEach(text -> {
            String textStr = removeTilFormat(Utils.removeFormat(text.getString()));
    ...
    public List<Text> buildLore() {
        ...
        try {
            ...
            Cast cast = type.getCast() != null ? type.getCast() : WynnBuildClient.cast;
